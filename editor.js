...
var editor = (function () {
  ...
  var init = {
    ...
    start: function () {
      ...
      var save =
        "1,p,5.000,12.200,1,473,480\n" +
        "2,p,2.949,5.262,2,473,481,489\n" +
        "3,p,6.602,7.935,2,480,481,482\n" +
        "10,p,10.972,7.619,2,482,488,494\n" +
        "11,p,9.733,2.933,2,488,489,495\n" +
        "12,p,14.333,5.800,2,494,495,496\n" +
        "21,p,13.133,12.400,0,496\n" +
        "473,e,2,1,479\n" +
        "479,g,473,480,481\n" +
        "480,e,3,1,479\n" +
        "481,e,3,2,479\n" +
    ...
    callbacks: function () {
      ...
      controls.play.addEventListener('click', function (e) {
        ...
        dashboard.pointType.readOnly = true;
        dashboard.pointX.readOnly = true;
        dashboard.pointY.readOnly = true;
        dashboard.edgeLength.readOnly = true;
      ...
      controls.pause.addEventListener('click', function (e) {
        ...
        dashboard.pointType.readOnly = false;
        dashboard.pointX.readOnly = false;
        dashboard.pointY.readOnly = false;
        dashboard.edgeLength.readOnly = false;
